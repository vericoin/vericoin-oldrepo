...
static const unsigned int MAX_ORPHAN_TRANSACTIONS = 500;
...
public:
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64_t& nCoinAge, CBlockIndex* pindexPrev) const;  // ppcoin: get transaction coin age
